#ifndef AHCI_H_INCLUDED
#define AHCI_H_INCLUDED
...
struct FIS_PIO_SETUP: public FIS
{
	// DWORD 0
...
struct FIS_DMA_SETUP: public FIS
{
	// DWORD 0
	...
	//DWORD 1&2
        ...
        unsigned long DMAbufferID;    // DMA Buffer Identifier. Used to Identify DMA buffer in host memory.
...
class AHCIController : public PCIEDevice {
	HBA_MEM* abar;
	int check_type(HBA_PORT *port);
	friend class SATADisk;
public:
	AHCIController(u64 address);
};
